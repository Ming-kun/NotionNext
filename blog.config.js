...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '3a1c8776f4d045ce903cb29eaf0bd34b,zh:1ff9d71291a8801abfdffb1b7213de22',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'The Path to AGI', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://stealingfire.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, Blog，Stealingfire', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://stealingfire.cc/', // 备案查询链接，如果用了萌备等备案请在这里填写
  ...
  GREETING_WORDS:
    ...
    'Welcome to the Stealing Fire Knowledge Hub!',
